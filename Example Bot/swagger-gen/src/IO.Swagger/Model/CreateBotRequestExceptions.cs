...
namespace IO.Swagger.Model
{
    ...
    public partial class CreateBotRequestExceptions :  IEquatable<CreateBotRequestExceptions>, IValidatableObject
    {
        ...
        public CreateBotRequestExceptions(int? Id = default(int?), bool? IsConflict = default(bool?), bool? RequiresAdmin = default(bool?), int? RequiredFeedback = default(int?), List<int?> BotResponseConflictFeedbacks = default(List<int?>))
        {
            this.Id = Id;
