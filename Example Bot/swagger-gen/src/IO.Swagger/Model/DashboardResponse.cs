...
namespace IO.Swagger.Model
{
    ...
    public partial class DashboardResponse :  IEquatable<DashboardResponse>, IValidatableObject
    {
        ...
        /// <param name="BotName">BotName (required).</param>
        ...
        public DashboardResponse(int? Id = default(int?), string BotName = default(string), string DashboardName = default(string), string Description = default(string), int? RequiredFeedback = default(int?), int? RequiredFeedbackConflicted = default(int?), int? OwnerAccountId = default(int?), string Homepage = default(string), string LogoUrl = default(string), string FavIcon = default(string), string TabTitle = default(string), List<BotResponseFeedback> Feedbacks = default(List<BotResponseFeedback>), List<BotResponseConflictExceptions> ConflictExceptions = default(List<BotResponseConflictExceptions>))
        {
            ...
            if (BotName == null)
            {
                throw new InvalidDataException("BotName is a required property for DashboardResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DashboardName is a required property for DashboardResponse and cannot be null");
            }
            else
            {
            ...
            if (Description == null)
            {
                throw new InvalidDataException("Description is a required property for DashboardResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("RequiredFeedback is a required property for DashboardResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("RequiredFeedbackConflicted is a required property for DashboardResponse and cannot be null");
            }
            else
            {
