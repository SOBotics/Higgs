...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateBotRequest :  IEquatable<CreateBotRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBotRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateBotRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBotRequest" /> class.
        /// </summary>
        ...
        public CreateBotRequest(int? OwnerAccountId = default(int?), string Secret = default(string), string Name = default(string), string DashboardName = default(string), string Description = default(string), string Homepage = default(string), string LogoUrl = default(string), string FavIcon = default(string), string TabTitle = default(string), List<CreateBotRequestFeedback> Feedbacks = default(List<CreateBotRequestFeedback>), List<CreateBotRequestExceptions> ConflictExceptions = default(List<CreateBotRequestExceptions>), int? RequiredFeedback = default(int?), int? RequiredFeedbackConflicted = default(int?))
        {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for CreateBotRequest and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            {
                throw new InvalidDataException("DashboardName is a required property for CreateBotRequest and cannot be null");
            }
            else
            {
            ...
            if (Description == null)
            {
                throw new InvalidDataException("Description is a required property for CreateBotRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("RequiredFeedback is a required property for CreateBotRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("RequiredFeedbackConflicted is a required property for CreateBotRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CreateBotRequest);
        }

        /// <summary>
        /// Returns true if CreateBotRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateBotRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateBotRequest input)
        {
            if (input == null)
                return false;
