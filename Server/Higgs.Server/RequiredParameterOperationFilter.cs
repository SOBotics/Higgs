    ...
    public class RequiredParameterOperationFilter : IOperationFilter
    {
        public void Apply(Operation operation, OperationFilterContext context)
        {
            ...
            foreach (var parameterDescription in context.ApiDescription.ParameterDescriptions)
                if (parameterDescription.ParameterDescriptor is ControllerParameterDescriptor
                    controllerParameterDescription)
                    if (controllerParameterDescription.ParameterInfo.GetCustomAttribute(typeof(RequiredAttribute)) !=
                        null)
