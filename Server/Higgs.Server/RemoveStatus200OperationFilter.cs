...
namespace Higgs.Server
{
    ...
    public class RemoveStatus200OperationFilter : IOperationFilter
	{
	    ...
	    {
		    if (context.ApiDescription.ActionAttributes().OfType<RemoveStatus200Attribute>().Union(context.ApiDescription.ActionAttributes().OfType<RemoveStatus200Attribute>()).Any())
		    {
